...
echo.                                                                                                                                                       >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
echo             ' Wait for animation and end running processes                                                                                             >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
echo             Dim TabTip = Process.GetProcessesByName("TabTip")                                                                                          >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
echo                 TabTip(0).CloseMainWindow()                                                                                                            >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
echo             Thread.Sleep(500)                                                                                                                          >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
echo             Dim TextInputHost = Process.GetProcessesByName("TextInputHost")                                                                            >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
echo                 TextInputHost(0).CloseMainWindow()                                                                                                     >> "%APPDATA%\TabTipProxy\TabTipProxy.vb"
